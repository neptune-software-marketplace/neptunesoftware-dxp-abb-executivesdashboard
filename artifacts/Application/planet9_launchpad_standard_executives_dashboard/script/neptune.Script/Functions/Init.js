...
//Remove Theme change button when on HCM Launchpad
var launchpadURL = window.location.href; 

if(launchpadURL.includes("HCM-Portal")){
    ButtonThemeChange.setVisible(false);
...
sap.ui.getCore().attachInit(function () {
    ...
    sap.ui.getCore().attachThemeChanged(function () {
        ...
        if (result1 === true) {
             AppCacheShellLogoDesktop.setSrc("https://dxpdemo.neptune-software.cloud/media/root/DXPDemo%20launchpad/dark%20mode.png");
             AppCacheShellLogoMobile.setSrc("https://dxpdemo.neptune-software.cloud/media/root/DXPDemo%20launchpad/dark%20mode.png");
        } else {
             AppCacheShellLogoDesktop.setSrc("https://dxpdemo.neptune-software.cloud/media/root/DXPDemo%20launchpad/ligth%20mode.png");
             AppCacheShellLogoMobile.setSrc("https://dxpdemo.neptune-software.cloud/media/root/DXPDemo%20launchpad/ligth%20mode.png");
        }
    });
    ...
    setTimeout(function () {
        // Browser Title
        if (AppCache.launchpadTitle && AppCache.launchpadTitle !== "null")
            document.title = AppCache.launchpadTitle;
        ...
        // Phone UI Handling
        if (sap.n.Launchpad.isPhone()) {
            [AppCache_boxLogonCenter, AppCache_boxLogonPasscode, AppCache_boxLogonUsers].forEach(
                function (i) {
                    i.setHeight("100%");
        ...
        if (AppCache.isMobile) {
            ...
            if (AppCache.layout) {
                ...
                AppCache.layout.forEach(function (data) {
                    inAppCacheFormSettingsTHEME.addItem(
                ...
                if (params["nep-ui-layout"])
                    modelAppCacheDiaSettings.oData.userTheme = params["nep-ui-layout"];
